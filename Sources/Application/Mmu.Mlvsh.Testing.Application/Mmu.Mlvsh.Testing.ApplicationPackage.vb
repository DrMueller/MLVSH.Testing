...
<Guid(Mmu.Mlvsh.Testing.ApplicationPackage.PackageGuidString)>
Public NotInheritable Class Mmu.Mlvsh.Testing.ApplicationPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "c543a57b-1e58-42d2-b7a5-2646982a00b7"
